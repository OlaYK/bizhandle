  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        glow: "0 0 0 1px rgba(39,194,92,0.12), 0 6px 24px rgba(39,194,92,0.13)",
      },
      keyframes: {
        "fade-up": {
        ...
        shimmer: {
          "0%": { backgroundPosition: "-180% 0", opacity: "1" },
          "80%": { backgroundPosition: "140% 0", opacity: "1" },
      ...
      animation: {
        ...
        shimmer: "shimmer 1.9s linear 1 forwards",
      },
    },
  },
  plugins: [],
