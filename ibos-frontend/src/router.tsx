...
const CreditProfilePage = lazy(() =>
  import("./pages/credit-profile-page").then((module) => ({
    default: module.CreditProfilePage,
  })),
);
const TeamPage = lazy(() =>
...
const StorefrontSettingsPage = lazy(() =>
  import("./pages/storefront-settings-page").then((module) => ({
    default: module.StorefrontSettingsPage,
  })),
);
const StorefrontPage = lazy(() =>
  import("./pages/storefront-page").then((module) => ({
    default: module.StorefrontPage,
  })),
);
const StorefrontProductPage = lazy(() =>
  import("./pages/storefront-product-page").then((module) => ({
    default: module.StorefrontProductPage,
  })),
);
const PaymentsPage = lazy(() =>
  import("./pages/payments-page").then((module) => ({
    default: module.PaymentsPage,
  })),
);
const ShippingPage = lazy(() =>
  import("./pages/shipping-page").then((module) => ({
...
const DeveloperPortalPage = lazy(() =>
  import("./pages/developer-portal-page").then((module) => ({
    default: module.DeveloperPortalPage,
  })),
);
...
export const router = createBrowserRouter([
  ...
  { path: "/store/:slug", element: withSuspense(<StorefrontPage />) },
  {
    ...
    element: withSuspense(<StorefrontProductPage />),
  },
  {
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "/developers",
            element: withSuspense(<DeveloperPortalPage />),
          },
          ...
          {
            path: "/credit-profile",
            element: withSuspense(<CreditProfilePage />),
          },
          ...
          { path: "/settings", element: withSuspense(<SettingsPage />) },
          {
            ...
            element: withSuspense(<StorefrontSettingsPage />),
          },
        ],
      },
    ],
