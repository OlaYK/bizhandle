...
export function Card({ className, children }: CardProps) {
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,rgba(248,194,13,0.8),transparent)] bg-[length:220%_100%] duration-300 animate-shimmer" />
      {children}
    </div>
  );
}
